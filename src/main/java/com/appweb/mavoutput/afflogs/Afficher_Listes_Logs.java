...
public class Afficher_Listes_Logs extends Displayer {
	...
	public ModelAndView afficherListeLightLog(ModelAndView mav,
		...
		// Fonction qui affiche tous les logs de la base de donn�es, � terme elle
		String type = "FirstLogAnalyzer";
		Collection<LogAnalyzer> logs = builder.buildLogAnalyzer(find(selectedregexp), type);// V�rifier que la complexit� soit pas trop grande
...
//		logs = (ArrayList<LogAnalyzer>) logs;
		// Permet de r�cuperer toutes les datas d'un type 			
